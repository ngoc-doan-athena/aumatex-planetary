...
const LabelSuccess = tw.span`inline-block py-2 px-2 lg:w-28 rounded-full text-[0.8rem] font-normal bg-state-success/10 text-state-success border border-solid border-state-success text-center ml-2`;
const LabelDanger = tw.span`inline-block py-2 px-2 lg:w-28 rounded-full text-[0.8rem] font-normal bg-state-danger/10 text-state-danger border border-solid border-state-danger text-center ml-2`;
